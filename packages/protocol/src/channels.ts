...
export interface BrowserContextChannel extends BrowserContextEventTarget, EventTargetChannel {
  ...
  recorderSupplementEnable(params: BrowserContextRecorderSupplementEnableParams, actionCallback?: ActionCallback, metadata?: CallMetadata): Promise<BrowserContextRecorderSupplementEnableResult>;
